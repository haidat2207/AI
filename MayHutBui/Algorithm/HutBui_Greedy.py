...
class Node:
    def __init__(self, state, x, y, node_parent=None, action=None, cost=0):
        self.state = state
        self.x = x
        self.y = y
...
def Greedy(initial_state, goal_state, x, y):
...
# result = Greedy(initial_state, goal_state, x, y)
